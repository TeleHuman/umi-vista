...
DATASET_REPO_ID="LIBERO/libero-rhodes-lerobot"
...
POLICY_PATH="$HF_HUB_CACHE/models--lerobot--pi0_base"
...
OUTPUT_DIR="outputs/train_pi0/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
