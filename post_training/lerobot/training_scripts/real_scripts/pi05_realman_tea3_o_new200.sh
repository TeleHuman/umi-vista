...
DATASET_REPO_ID="/gemini/space/users/ysy/data/dataset/real/realman_tea/1.28tae3_convert/1.28tae3_convert/without_s6f/1.28tea3"
# DATASET_REPO_ID="IPEC-COMMUNITY/bridge_orig_lerobot"
DATASET_ROOT="/gemini/space/users/ysy/data/dataset/real/realman_tea/1.28tae3_convert/1.28tae3_convert/without_s6f/1.28tea3"
...
OUTPUT_DIR="outputs/real_task/train_realman_tea3_pi05_o_new200/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
echo "Output dir: $OUTPUT_DIR"
# ------------------------------------------------------------

cd /gemini/space/users/ysy/project/TEXAS/third_party/RhodesLeRobot
### accelerate launch command
python   src/lerobot/scripts/lerobot_train_o.py \
