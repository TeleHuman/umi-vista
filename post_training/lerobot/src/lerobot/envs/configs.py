...
class LiberoEnv(EnvConfig):
    ...
    # HDF5 debug / teacher-forcing replay
    hdf5_path: str | None = None
    hdf5_demo_name: str = "demo_0"
    hdf5_replay: bool = False
    hdf5_compare_policy: bool = False
    hdf5_debug_dir: str | None = None
    ...
    #     }
    # )
    features: dict[str, PolicyFeature] = field( ##umi(5)
        default_factory=lambda: {
    ...
    #     }
    # )
    features_map: dict[str, str] = field( ##umi(4)
        default_factory=lambda: {
            ACTION: ACTION,
            "agent_pos": OBS_STATE,
            "pixels/agentview_image": f"{OBS_IMAGES}.unused_image",
            "pixels/robot0_eye_in_hand_image": f"{OBS_IMAGES}.wrist_image",
        }
    )
    ...
    def gym_kwargs(self) -> dict:
        ...
        if self.hdf5_path is not None:
            kwargs["hdf5_path"] = self.hdf5_path
            kwargs["hdf5_demo_name"] = self.hdf5_demo_name
            kwargs["hdf5_replay"] = self.hdf5_replay
            kwargs["hdf5_compare_policy"] = self.hdf5_compare_policy
            kwargs["hdf5_debug_dir"] = self.hdf5_debug_dir
            kwargs["hdf5_use_obs_image"] = self.hdf5_use_obs_image
            kwargs["hdf5_obs_image_key"] = self.hdf5_obs_image_key
        return kwargs
