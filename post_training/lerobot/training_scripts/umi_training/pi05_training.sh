...
DATASET_REPO_ID="/gemini/space/users/glz/data/lerobot_v21/cube_sponge_umi"
...
OUTPUT_DIR="/gemini/space/users/ysy/data/training_output/ft_pi05/ft_tele_haimian_abs/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
echo "Output dir: $OUTPUT_DIR"
# ------------------------------------------------------------

cd /gemini/space/users/ysy/project/TEXAS/third_party/RhodesLeRobot
### accelerate launch command
python   src/lerobot/scripts/lerobot_train_umi.py \
