...
DATASET_REPO_ID="/gemini/space/users/ysy/data/dataset/real/feixi/build_3Dprint_new_no_desk"
# DATASET_REPO_ID="IPEC-COMMUNITY/bridge_orig_lerobot"
DATASET_ROOT="/gemini/space/users/ysy/data/dataset/real/feixi/build_3Dprint_new_no_desk"
...
OUTPUT_DIR="outputs/real_task/train_feixi_3dprint_pi05_o_newcam/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
