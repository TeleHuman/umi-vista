...
OUTPUT_DIR="outputs/real_task/temp/train_feixi_3dprint_pi05_o_wo_trans/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
