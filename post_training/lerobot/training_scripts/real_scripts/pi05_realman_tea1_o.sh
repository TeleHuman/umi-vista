...
DATASET_REPO_ID="/gemini/space/users/ysy/data/dataset/real/realman_tea/1.15tea1_convert/without_s6f/1.15tea1"
# DATASET_REPO_ID="IPEC-COMMUNITY/bridge_orig_lerobot"
DATASET_ROOT="/gemini/space/users/ysy/data/dataset/real/realman_tea/1.15tea1_convert/without_s6f/1.15tea1"
...
OUTPUT_DIR="outputs/real_task/train_realman_tea1_pi05_o_action_chunk20/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
