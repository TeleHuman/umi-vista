...
DATASET_REPO_ID="/gemini/space/users/ysy/data/dataset/real/realman_tea/1.16tea2_convert/1.16tea2_convert/without_s6f/1.16tea2"
# DATASET_REPO_ID="IPEC-COMMUNITY/bridge_orig_lerobot"
DATASET_ROOT="/gemini/space/users/ysy/data/dataset/real/realman_tea/1.16tea2_convert/1.16tea2_convert/without_s6f/1.16tea2"
...
OUTPUT_DIR="outputs/real_task/train_realman_tea2_pi05_o/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
