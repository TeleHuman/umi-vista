...
# OUTPUT_DIR="outputs/train_pi05_${bench}_beta${advantage_beta}_good_critic_mc/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
# # td
...
DATASET_REVISION="v3.0"
# # td
critic_model_ckpt="/gemini/platform/public/embodiedAI/huggingface_cache/hub/models--breezeyoung--texas_libero_TD_5epochs/snapshots/06994149d2a48b2e82b82842ebbc7c59530fe885"
OUTPUT_DIR="outputs/aaa-0121/train_pi05_${bench}_beta${advantage_beta}_good_critic_td/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"

# critic_model_ckpt=""
# OUTPUT_DIR="outputs/train_pi05_${bench}_o/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
