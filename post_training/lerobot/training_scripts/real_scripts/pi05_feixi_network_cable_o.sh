...
OUTPUT_DIR="outputs/real_task/train_feixi_network_cable_pi05_o/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
