...
DATASET_REPO_ID="/gemini/space/users/ysy/data/dataset/real/feixi/network_cable"
# DATASET_REPO_ID="IPEC-COMMUNITY/bridge_orig_lerobot"
DATASET_ROOT="/gemini/space/users/ysy/data/dataset/real/feixi/network_cable"
...
OUTPUT_DIR="outputs/real_task/train_feixi_network_cable_pi05_o_good_gripper/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
