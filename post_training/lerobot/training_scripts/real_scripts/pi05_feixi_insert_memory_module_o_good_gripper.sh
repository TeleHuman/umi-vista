...
DATASET_REPO_ID="/gemini/space/users/ysy/data/dataset/real/feixi/insert_memory_module"
# DATASET_REPO_ID="IPEC-COMMUNITY/bridge_orig_lerobot"
DATASET_ROOT="/gemini/space/users/ysy/data/dataset/real/feixi/insert_memory_module"
...
OUTPUT_DIR="outputs/real_task/aaa-0129/train_feixi_insert_memory_module_pi05_o_good_gripper/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
echo "Output dir: $OUTPUT_DIR"
# ------------------------------------------------------------

export use_corr_state="True"
