...
DATASET_REPO_ID="IPEC-COMMUNITY/fractal20220817_data_lerobot_temp"
...
# OUTPUT_DIR="outputs/train_pi05/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
OUTPUT_DIR="/gemini/space/users/ysy/project/temp/train_pi05/${DATASET_NAME}/${DATE1}_${TIME1}_${MODEL_NAME}_${GPU_NUM}_${CHUNK_SIZE}_${LR}_${BS}_${STEPS}_${SEED_STR}"
echo "Output dir: $OUTPUT_DIR"
# ------------------------------------------------------------

cd /gemini/space/users/ysy/project/RhodesLeRobot_new_in/
### accelerate launch command
python   src/lerobot/scripts/lerobot_train_old.py \
    --dataset.repo_id=$DATASET_REPO_ID \
    --policy.type=pi05 \
    --output_dir=./outputs/pi05_training-50tasks \
